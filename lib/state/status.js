...
var cooler = new Cooldown("1s", function()
{
  ...
  var hour_diff = hour(clock+clock_adj, true) - hour(clock, true)
  if (hour_diff != 0)
  {
    require('state/board').new_hour(hour_diff)
  }
...
exports.raw_cash = function()
{
  return cash;
}

var messages_show = new Cooldown("1s", function()
{
  messages.shift();
